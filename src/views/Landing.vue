                        ...
                        <div class="row row-grid">
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    ...
                                    <h6 class="text-primary text-uppercase">Submit Your Order</h6>
                                    <p class="description mt-3">
                                      Use moveX web platform to create an order with the necessary details
                                    </p>
                                    <div>
                                        <badge type="primary" rounded>Delivery details</badge>
                                        <badge type="primary" rounded>Delivery requests</badge>
                                    </div>
                                </card>
                            </div>
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    <icon name="ni ni-pin-3" type="success" rounded class="mb-4">
                                    </icon>
                                    <h6 class="text-success text-uppercase">We Pick-Up</h6>
                                    <p class="description mt-3">Our courier service locate your address to pick up the delivery.</p>
                                    <div>
                                        <badge type="success" rounded>Find your location</badge>
                                        <badge type="success" rounded>Pick-up</badge>
                                    </div>
                                </card>
                            </div>
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    <icon name="ni ni-delivery-fast" type="warning" rounded class="mb-4">
                                    </icon>
                                    <h6 class="text-warning text-uppercase">Express Delivery</h6>
                                    <p class="description mt-3">We deliver the order to the stated person and in the previously stated location</p>
                                    <div>
                                        <badge type="warning" rounded>Happy cusotmer</badge>
                                        <badge type="warning" rounded>delivery</badge>
                                    </div>
                                </card>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 order-md-1">
                        <div class="pr-md-5">
                            <icon name="ni ni-settings-gear-65" class="mb-5" size="lg" type="success" shadow
                                  rounded></icon>
                            <h3>Awesome Platform Experience</h3>
                            <p>Our platform comes with a lot of benefit that makes our users happy and satisfied. <br>We make sure our clients get the best experience with us.</p>
                            <ul class="list-unstyled mt-5">
                                <li class="py-2">
                                    <div class="d-flex align-items-center">
                                        <badge type="success" circle class="mr-3" icon="ni ni-check-bold"></badge>
                                        <h6 class="mb-0">Ease of access</h6>
                                    </div>
                                </li>
                                <li class="py-2">
                                    <div class="d-flex align-items-center">
                                        <badge type="success" circle class="mr-3" icon="ni ni-check-bold"></badge>
                                        <h6 class="mb-0">Amazing experience with our couriers</h6>
                                    </div>
                                </li>
                                <li class="py-2">
                                    <div class="d-flex align-items-center">
                ...
                <div class="row row-grid align-items-center">
                    <div class="col-md-6">
                        <div class="card bg-default shadow border-0">
                            <img v-lazy="'img/pexels1.jpeg'" class="card-img-top">
                            <blockquote class="card-blockquote">
                                ...
                                <h4 class="display-3 font-weight-bold text-white">Delivery System</h4>
                                <p class="lead text-italic text-white">
                                  Our delivery system is well designed and it is designed to be fast and efficient
                                </p>
                            </blockquote>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="pl-md-5">
                            <icon name="ni ni-single-02" class="mb-5" size="lg" type="warning" shadow rounded></icon>

                            <h3>Your customers</h3>
                            <p class="lead">Don't let your orders going missing become a conflict between you and your clients</p>
                            <p>Don't let your orders being rough handled by the courier service become a conflict between you and your clients</p>
                            <p>Make your relationship with your customer better by helping them get their delivery in time</p>
                            <p class="font-weight-bold text-warning mt-5">We make sure you get all these at an affordable price</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row row-grid align-items-center">
                    ...
                    <div class="col-lg-6 order-lg-1">
                        <div class="d-flex px-3">
                            ...
                            <div class="pl-4">
                                <h4 class="display-3 text-white">Customer Support</h4>
                                <p class="text-white">Here at moveX we understand and care for our users and this is why we make sure we are always there for them when they need us</p>
                            </div>
                        </div>
                        <card shadow class="shadow-lg--hover mt-5">
                            <div class="d-flex px-3">
                                ...
                                <div class="pl-4">
                                    ...
                                    <p>Our support team is here for you. <br>The goal of our support team is to eliminate the terrible narrative about customer support teams</p>
                                </div>
                            </div>
                        </card>
                        <card shadow class="shadow-lg--hover mt-5">
                            <div class="d-flex px-3">
                                <div>
                                    <icon name="ni ni-user-run" gradient="warning" color="white" shadow
                                          rounded></icon>
                                </div>
                                <div class="pl-4">
                                    <h5 class="title text-warning">Response Time</h5>
                                    <p>In the industry today time of utmost importance and this why we do our best to minimize the time you spend talking to a customer care agent by answering quick</p>
                                </div>
                            </div>
                        </card>
                    </div>
        ...
        <section class="section section-shaped my-0 overflow-hidden">
            ...
            <div class="container pt-lg pb-300">
                <div class="row text-center justify-content-center">
                    <div class="col-lg-10">
                        <h2 class="display-3 text-white">Reach Out To Us</h2>
                        <p class="lead text-white">
                          We would go through your requests, complaint and suggestions and get back to you as soon as we can
                        </p>
                    </div>
                </div>
                ...
                <div class="row justify-content-center mt--300">
                    <div class="col-lg-8">
                        <card gradient="secondary" shadow body-classes="p-lg-5">
                            <h4 class="mb-1">Got a message for moveX?</h4>
